...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  install_framework "${BUILT_PRODUCTS_DIR}/AppContext/AppContext.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/Feature4/Feature4.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/Services/Services.framework"
